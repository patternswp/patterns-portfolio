 ...
 * @subpackage Patterns_Portfolio/includes/api
 */
 ...
 */
if ( ! class_exists( 'Patterns_Portfolio_Api' ) ) {

	/**
	 * Patterns_Portfolio_Api
	 *
	 * @package Patterns_Portfolio
	 * @since 1.0.1
	 */
	class Patterns_Portfolio_Api extends WP_REST_Controller {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'patterns-portfolio' ), '1.0.0' );
		}
