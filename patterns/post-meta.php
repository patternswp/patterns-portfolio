...
/**
 * Title: Post Meta
 * Slug: patterns-portfolio/post-meta
 * Categories: posts
...
<p class="has-tertiary-color has-text-color" style="margin-bottom:0px"><?php esc_html_e( 'Posted :', 'patterns-portfolio' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group" style="font-size:14px"><!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"0px"}}},"textColor":"tertiary"} -->
<p class="has-tertiary-color has-text-color" style="margin-bottom:0px"><?php esc_html_e( 'by :', 'patterns-portfolio' ); ?></p>
<!-- /wp:paragraph -->
