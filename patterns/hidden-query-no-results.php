 ...
 * Slug: patterns-portfolio/hidden-query-no-results
 * Inserter: no
...
<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Page could not be found', 'patterns-portfolio' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e( 'We\'re sorry, the page you requested could not be found. Please go back to the homepage', 'patterns-portfolio' ); ?></p>
<!-- /wp:paragraph -->
